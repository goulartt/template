...
\lfoot{\footnotesize \texttt{Template de documento para processo de software} \textbullet ~Modelo de BJR}
...
\title{Modelo de Processo Ágil BJR}					% Title of your article goes here
