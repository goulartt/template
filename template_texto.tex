...
\subsection{Fases}
	...
	A fase de Desenvolvimento começa com uma discussão sobre os itens que deverão ser produzidos. Durante essa fase são definidos quais itens serão feitos e qual será a ordem de execução baseado nas prioridades do cliente. Assim que os itens são definidos começa-se a produção dos mesmos. E toda essa fase de desenvolvimento será chamada de Sprint, que é a junção dos itens por ordem de prioridade removidas do backlog para entrar em linha de desenvolvimento, quando concluída a Sprint é passado para a próxima fase do processo.
